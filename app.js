    ...
    if (msg === "test") {
      ...
      response = {
        attachment: {
          type: "image",
          payload: {
            url: "https://media.tenor.com/JvArM7ZO5JIAAAAM/bavatogay-ricardo-milos.gif",
            is_reusable: true,
          },
        },
      };
      ...
      response = {
        attachment: {
          type: "video",
          payload: {
            url: "https://cdn.glitch.global/df116b28-1bf9-459e-9b76-9696e80b6334/videoplayback.mp4?v=1680496763221",
            is_reusable: true,
          },
        },
      };
